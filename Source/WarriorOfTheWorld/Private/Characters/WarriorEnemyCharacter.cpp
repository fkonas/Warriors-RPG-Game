...
AWarriorEnemyCharacter::AWarriorEnemyCharacter()
{
	...
	EnemyCombotComponent = CreateDefaultSubobject<UEnemyCombotComponent>("EnemyCombotComponent");
...
UPawnCombotComponent* AWarriorEnemyCharacter::GetPawnCombotComponent() const
{
	return EnemyCombotComponent;
}
...
void AWarriorEnemyCharacter::OnBodyCollisionBoxBeginOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
	if (APawn* HitPawn = Cast<APawn>(OtherActor))
	{
		...
		{
			EnemyCombotComponent->OnHitTargetActor(HitPawn);
		}
	}
}
