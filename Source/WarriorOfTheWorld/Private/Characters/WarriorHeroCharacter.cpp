...
UPawnCombotComponent* AWarriorHeroCharacter::GetPawnCombotComponent() const
{
	return HeroCombotComponent;
}
...
void AWarriorHeroCharacter::Input_SwitchTargetCompleted(const FInputActionValue& InputActionValue)
{
	...
	UAbilitySystemBlueprintLibrary::SendGameplayEventToActor(
		this, 
		SwitchDirection.X > 0.f ? WarriorGameplayTags::Player_Event_SwitchTarget_Rigth : WarriorGameplayTags::Player_Event_SwitchTarget_Left,
		Data
	);
}
